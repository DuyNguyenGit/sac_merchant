...
public final class QrcodeDynamicGeneratePresenterImpl extends BasePresenterImpl<QrcodeDynamicGenerateView> implements QrcodeDynamicGeneratePresenter {
    /**
     * The interactor
     */
    @NonNull
    private final QrcodeDynamicGenerateInteractor mInteractor;

    // The view is available using the mView variable

    @Inject
    public QrcodeDynamicGeneratePresenterImpl(@NonNull QrcodeDynamicGenerateInteractor interactor) {
